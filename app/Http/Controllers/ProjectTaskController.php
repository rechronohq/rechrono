    ...
    public function store(Request $request, Project $project): JsonResponse
    {
        ...
        if ($kind === Task::KIND_GROUP) {
            ...
            if (! array_key_exists('start_date', $validated) || $validated['start_date'] === null) {
                $groupDateErrors['start_date'] = 'The start date field is required.';
            }

            if (! array_key_exists('end_date', $validated) || $validated['end_date'] === null) {
                $groupDateErrors['end_date'] = 'The end date field is required.';
            }

            if ($groupDateErrors !== []) {
                throw ValidationException::withMessages($groupDateErrors);
            }
        }
